...
public class BNDemoGuideActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServiceOrderActivity.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(ServiceOrderActivity.ROUTE_PLAN_NODE);
    ...
    protected void onDestroy() {
        ...
        ServiceOrderActivity.activityList.remove(this);
