...
public class LoginPwdActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void initView() {
        ...
        phone.setText(ShareDataTool.getRegiterEntity(this).phone);
...
//        String temp = codeView.getText().toString().trim();
        ...
        utils.send(HttpRequest.HttpMethod.POST, Constant.ROOT_PATH + "sms/sendAuthCode", rp,
                new RequestCallBack<String>() {
                    ...
                    public void onFailure(HttpException arg0, String arg1) {
                        ...
                        ToastUtils.displayFailureToast(LoginPwdActivity.this);
                    }
                        ...
                        try {
                            ...
                            if (Constant.RETURN_OK.equals(state.msg)) {
                                ToastUtils.displayShortToast(
                                        LoginPwdActivity.this, "发送成功！");
                                time.start();
                            } else {
                                ToastUtils.displayShortToast(
                                        LoginPwdActivity.this,
                                        (String) state.result);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            ToastUtils
                                    .displaySendFailureToast(LoginPwdActivity.this);
                        }
    ...
    private void UpdateUserInfo() {
        ...
        utils.send(HttpRequest.HttpMethod.POST, Constant.ROOT_PATH
                + "user/findOrUpdatePwd", rp, new RequestCallBack<String>() {
            @Override
            public void onStart() {
                pro.setVisibility(View.VISIBLE);
                super.onStart();
            ...
            public void onSuccess(ResponseInfo<String> arg0) {
                ...
                try {
                    ...
                    if (Constant.RETURN_OK.equals(state.msg)) {
                        LogManager.LogShow("-----", arg0.result,
                                LogManager.ERROR);
                        ToastUtils.displayShortToast(LoginPwdActivity.this, "修改成功");
                        finish();
                    } else if (Constant.TOKEN_ERR.equals(state.msg)) {
                        ToastUtils.displayShortToast(LoginPwdActivity.this,
                                "验证错误，请重新登录");
                        ToosUtils.goReLogin(LoginPwdActivity.this);
                    } else {
                        ToastUtils.displayShortToast(LoginPwdActivity.this,
                                (String) state.result);
                    }
                } catch (Exception e) {
                    ToastUtils.displaySendFailureToast(LoginPwdActivity.this);
                }
