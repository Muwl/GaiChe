...
public class BlowfishECB {
	 ...
	 *            - 密钥
	 */
	public BlowfishECB(String bfkey) {
	...
	private SBlock bytesToBlock(byte buffer[], int nPos) {
		SBlock b = new SBlock();
		b.m_Hi = (int) ((buffer[nPos] & 0xFF) << 24
				| (buffer[nPos + 1] & 0xFF) << 16
				| (buffer[nPos + 2] & 0xFF) << 8 | (buffer[nPos + 3] & 0xFF));
		b.m_Lo = (int) ((buffer[nPos + 4] & 0xFF) << 24
				| (buffer[nPos + 5] & 0xFF) << 16
				| (buffer[nPos + 6] & 0xFF) << 8 | (buffer[nPos + 7] & 0xFF));
		return b;
	}
...
//			return new String(b, "GBK");
	...
	public static void main(String[] args) {
		// BlowfishECB bf = new BlowfishECB(hex2byte("123456"));
		BlowfishECB bf = new BlowfishECB("tg!$@hup1*301%#c");
		// System.out.println(hexString(bf.encrypt(hex2byte("67D32699EFFDE4D8"))));
		// System.out.println(hexString(bf.decrypt(bf.encrypt(hex2byte("67D32699EFFDE4D8")))));

		long startTime = System.currentTimeMillis();
		// String str = bf.encrypt("汽车宝贝");
		// System.out.println("加密后：" + str);
		System.out
				.println("解密后："
						+ bf.decrypt(""));
