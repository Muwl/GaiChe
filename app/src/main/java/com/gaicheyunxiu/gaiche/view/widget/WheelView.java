...
package com.gaicheyunxiu.gaiche.view.widget;
...
import com.gaicheyunxiu.gaiche.view.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xfff,
			0xfff, 0xfff };
